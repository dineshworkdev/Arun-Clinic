  ...
  const reviews = [
    {
      ...
      text: '"The entire experience at Arun Dental Clinic was transformative. From the moment I walked in, the staff made me feel incredibly comfortable. The whitening treatment exceeded my expectations, and the follow-up care was exceptional. I finally have the smile I\'ve always wanted."',
    ...
    },
    {
      ...
      text: '"Found Arun Dental Clinic through a friend and I\'m so glad I did. The hygiene appointment was so thorough. I\'ve never had a dentist spend so much time explaining my oral health to me. Very educational and high-quality."',
    ...
    <section ref={containerRef} className="py-16 lg:py-24 px-6 md:px-12 lg:px-20 xl:px-32 w-full max-w-[1440px] mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-base sm:text-lg font-normal text-slate-800">
          Read authentic testimonials from individuals who trusted Arun Dental Clinic with their smiles.
        </p>
      </div>
